package com.kjmaster.quintelementa.foundation.item;
...
public class TooltipHelper {
	...
	public static MutableComponent holdShift(FontHelper.Palette palette, boolean highlighted) {
		return QuintElementaLang.translateDirect("tooltip.holdForDescription", QuintElementaLang.translateDirect("tooltip.keyShift")
				.withStyle(ChatFormatting.GRAY))
			.withStyle(ChatFormatting.DARK_GRAY);
	}

	public static void addHint(List<Component> tooltip, String hintKey, Object... messageParams) {
		QuintElementaLang.translate(hintKey + ".title").style(ChatFormatting.GOLD).forGoggles(tooltip);
		Component hint = QuintElementaLang.translateDirect(hintKey);
		List<Component> cutComponent = cutTextComponent(hint, FontHelper.Palette.GRAY_AND_WHITE);
		for (Component component : cutComponent)
			QuintElementaLang.builder().add(component).forGoggles(tooltip);
	}
